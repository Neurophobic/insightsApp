...
// Tasks controller
angular.module('tasks').controller('TasksController', ['$scope', '$stateParams', '$location', 'Authentication', 'Tasks','$rootScope',
	function($scope, $stateParams, $location, Authentication, Tasks, $rootScope) {
